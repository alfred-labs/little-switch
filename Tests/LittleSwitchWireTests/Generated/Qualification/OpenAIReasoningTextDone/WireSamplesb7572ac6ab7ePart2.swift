...
enum WireSamplesb7572ac6ab7ePart2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIReasoningTextDone.missing:type",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAIReasoningTextDone.null:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDone.collision",
            input: """
                {
            ...
            var value = try OpenAIReasoningTextDone(wireJSON: json)
