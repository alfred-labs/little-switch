...
enum WireSampleseaee70422860Part1 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAICustomInputDone.minimal",
            input: """
                {
                  \"input\": \"wire sample\",
                  \"item_id\": \"wire sample\",
        ...
        .init(
            name: "OpenAICustomInputDone.full",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAICustomInputDone.invalid-root",
            input: """
                null
                """,
        ...
        .init(
            name: "OpenAICustomInputDone.null:call_id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAICustomInputDone.missing:input",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAICustomInputDone.null:input",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAICustomInputDone.missing:item_id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAICustomInputDone.null:item_id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAICustomInputDone.null:name",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAICustomInputDone.missing:output_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
