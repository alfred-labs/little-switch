...
enum WireSamples5f0ccf2ffc3e {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicServerToolUseBlockType.enum:server_tool_use",
            input: """
                \"server_tool_use\"
                """,
            expectedError: nil
        ) { json in
            return try AnthropicServerToolUseBlockType(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicServerToolUseBlockType.invalid-enum",
            input: """
                \"__wire_unknown__\"
                """,
