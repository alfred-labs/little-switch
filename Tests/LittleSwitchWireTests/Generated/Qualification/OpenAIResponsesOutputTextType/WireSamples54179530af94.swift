...
enum WireSamples54179530af94 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIResponsesOutputTextType.enum:output_text",
            input: """
                \"output_text\"
                """,
            expectedError: nil
        ) { json in
            return try OpenAIResponsesOutputTextType(wireJSON: json).wireJSON()
        },
        .init(
            name: "OpenAIResponsesOutputTextType.invalid-enum",
            input: """
                \"__wire_unknown__\"
                """,
