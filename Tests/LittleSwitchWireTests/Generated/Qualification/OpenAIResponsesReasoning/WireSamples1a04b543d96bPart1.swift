...
enum WireSamples1a04b543d96bPart1 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIResponsesReasoning.minimal",
            input: """
                {
                  \"id\": \"wire sample\",
                  \"type\": \"reasoning\"
        ...
        .init(
            name: "OpenAIResponsesReasoning.full",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAIResponsesReasoning.invalid-root",
            input: """
                null
                """,
        ...
        .init(
            name: "OpenAIResponsesReasoning.null:content",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIResponsesReasoning.null:encrypted_content",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIResponsesReasoning.missing:id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIResponsesReasoning.null:id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
