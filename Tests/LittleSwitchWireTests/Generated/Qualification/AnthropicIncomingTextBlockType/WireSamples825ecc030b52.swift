...
enum WireSamples825ecc030b52 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicIncomingTextBlockType.enum:text",
            input: """
                \"text\"
                """,
            expectedError: nil
        ) { json in
            return try AnthropicIncomingTextBlockType(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicIncomingTextBlockType.invalid-enum",
            input: """
                \"__wire_unknown__\"
                """,
