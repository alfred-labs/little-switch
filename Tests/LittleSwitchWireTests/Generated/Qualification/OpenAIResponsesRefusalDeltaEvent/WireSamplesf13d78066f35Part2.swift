...
enum WireSamplesf13d78066f35Part2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIResponsesRefusalDeltaEvent.missing:type",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAIResponsesRefusalDeltaEvent.null:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIResponsesRefusalDeltaEvent.collision",
            input: """
                {
            ...
            var value = try OpenAIResponsesRefusalDeltaEvent(wireJSON: json)
