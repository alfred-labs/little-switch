...
enum WireSamples01c73f4bc225Part1 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicServerToolUseBlock.minimal",
            input: """
                {
                  \"id\": \"wire sample\",
                  \"input\": {
        ...
        .init(
            name: "AnthropicServerToolUseBlock.full",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicServerToolUseBlock.invalid-root",
            input: """
                null
                """,
        ...
        .init(
            name: "AnthropicServerToolUseBlock.null:caller",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicServerToolUseBlock.missing:id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicServerToolUseBlock.null:id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicServerToolUseBlock.missing:input",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicServerToolUseBlock.null:input",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
