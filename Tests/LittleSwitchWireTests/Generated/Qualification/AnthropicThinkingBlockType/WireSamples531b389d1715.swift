...
enum WireSamples531b389d1715 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicThinkingBlockType.enum:thinking",
            input: """
                \"thinking\"
                """,
            expectedError: nil
        ) { json in
            return try AnthropicThinkingBlockType(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicThinkingBlockType.invalid-enum",
            input: """
                \"__wire_unknown__\"
                """,
