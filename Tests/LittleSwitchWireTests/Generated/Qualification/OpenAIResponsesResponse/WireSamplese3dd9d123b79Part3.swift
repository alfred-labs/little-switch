...
enum WireSamplese3dd9d123b79Part3 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIResponsesResponse.null:status",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAIResponsesResponse.null:usage",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIResponsesResponse.collision",
            input: """
                {
                  \"id\": \"wire sample\"
                }
                """,
            expectedError: .init(.additionalFieldCollision, path: ["completed_at"])
        ) { json in
            var value = try OpenAIResponsesResponse(wireJSON: json)
            value.additionalFields["completed_at"] = .null
