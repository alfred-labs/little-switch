...
enum WireSamplescac7cdb2daf4 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicSearchCitationType.enum:search_result_location",
            input: """
                \"search_result_location\"
                """,
            expectedError: nil
        ) { json in
            return try AnthropicSearchCitationType(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicSearchCitationType.invalid-enum",
            input: """
                \"__wire_unknown__\"
                """,
