...
enum WireSamples337ebaa956d2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicCharCitationType.enum:char_location",
            input: """
                \"char_location\"
                """,
            expectedError: nil
        ) { json in
            return try AnthropicCharCitationType(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicCharCitationType.invalid-enum",
            input: """
                \"__wire_unknown__\"
                """,
