...
enum WireSamplesb7c0842fd64d {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicMessageDeltaEventType.enum:message_delta",
            input: """
                \"message_delta\"
                """,
            expectedError: nil
        ) { json in
            return try AnthropicMessageDeltaEventType(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicMessageDeltaEventType.invalid-enum",
            input: """
                \"__wire_unknown__\"
                """,
