...
enum WireSamples984b8a79dce4Part2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIReasoningSummaryPartAdded.missing:summary_index",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAIReasoningSummaryPartAdded.null:summary_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningSummaryPartAdded.missing:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningSummaryPartAdded.null:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningSummaryPartAdded.collision",
            input: """
                {
                  \"item_id\": \"wire sample\",
            ...
            var value = try OpenAIReasoningSummaryPartAdded(wireJSON: json)
