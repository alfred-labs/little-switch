...
enum WireSamples4de56eca1802Part2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicCharCitation.null:file_id",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "AnthropicCharCitation.missing:start_char_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
                ...
                """,
            expectedError: .init(.missingField, path: ["start_char_index"])
        ) { json in
            return try AnthropicCharCitation(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicCharCitation.null:start_char_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
                ...
                """,
            expectedError: .init(.unexpectedNull, path: ["start_char_index"])
        ) { json in
            return try AnthropicCharCitation(wireJSON: json).wireJSON()
        },
        .init(
            name: "AnthropicCharCitation.missing:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicCharCitation.null:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicCharCitation.collision",
            input: """
                {
                  \"cited_text\": \"wire sample\",
            ...
            var value = try AnthropicCharCitation(wireJSON: json)
