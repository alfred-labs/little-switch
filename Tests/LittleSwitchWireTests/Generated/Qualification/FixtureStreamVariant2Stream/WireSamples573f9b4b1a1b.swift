...
enum WireSamples573f9b4b1a1b {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "FixtureStreamVariant2Stream.literal",
            input: """
                true
                """,
            expectedError: nil
        ) { json in
            return try FixtureStreamVariant2Stream(wireJSON: json).wireJSON()
        },
        .init(
            name: "FixtureStreamVariant2Stream.invalid-literal",
            input: """
                false
                """,
