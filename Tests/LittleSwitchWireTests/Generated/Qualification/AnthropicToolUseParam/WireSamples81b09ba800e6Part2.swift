...
enum WireSamples81b09ba800e6Part2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicToolUseParam.null:type",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "AnthropicToolUseParam.collision",
            input: """
                {
                  \"id\": \"wire sample\",
                  \"input\": {
            ...
            var value = try AnthropicToolUseParam(wireJSON: json)
