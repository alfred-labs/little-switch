...
enum WireSamples5cce9953e5e2Part1 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIReasoningTextDelta.minimal",
            input: """
                {
        ...
        .init(
            name: "OpenAIReasoningTextDelta.full",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAIReasoningTextDelta.invalid-root",
            input: """
                null
                """,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.missing:content_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.null:content_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.missing:delta",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.null:delta",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.missing:item_id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.null:item_id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.missing:output_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIReasoningTextDelta.null:output_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
