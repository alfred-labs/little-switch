...
enum WireSamples55c8acc9e6a3Part2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAIResponsesTextDoneEvent.missing:type",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAIResponsesTextDoneEvent.null:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAIResponsesTextDoneEvent.collision",
            input: """
                {
            ...
            var value = try OpenAIResponsesTextDoneEvent(wireJSON: json)
