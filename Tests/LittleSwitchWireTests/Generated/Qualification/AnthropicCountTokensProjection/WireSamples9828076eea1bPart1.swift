...
enum WireSamples9828076eea1bPart1 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicCountTokensProjection.minimal",
            input: """
                {
                  \"messages\": [],
                  \"model\": \"wire sample\"
        ...
        .init(
            name: "AnthropicCountTokensProjection.full",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "AnthropicCountTokensProjection.invalid-root",
            input: """
                null
                """,
        ...
        .init(
            name: "AnthropicCountTokensProjection.null:cache_control",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicCountTokensProjection.missing:messages",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
