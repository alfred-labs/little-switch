...
enum WireSamples9828076eea1bPart2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "AnthropicCountTokensProjection.null:messages",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "AnthropicCountTokensProjection.missing:model",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "AnthropicCountTokensProjection.null:model",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
