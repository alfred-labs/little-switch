...
enum WireSamples63ec5fb908ddPart2 {
    static let samples: [WireGeneratedSample] = [
        .init(
            name: "OpenAITextAnnotationAdded.missing:item_id",
            input: """
                {
                  \"__wire_unknown__\": {
        ...
        .init(
            name: "OpenAITextAnnotationAdded.null:item_id",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAITextAnnotationAdded.missing:output_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAITextAnnotationAdded.null:output_index",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAITextAnnotationAdded.missing:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAITextAnnotationAdded.null:type",
            input: """
                {
                  \"__wire_unknown__\": {
                    \"exact_integer\": 9007199254740993,
        ...
        .init(
            name: "OpenAITextAnnotationAdded.collision",
            input: """
                {
                  \"annotation\": {
                    \"exact_integer\": 9007199254740993,
                ...
                """,
            expectedError: .init(.additionalFieldCollision, path: ["annotation"])
        ) { json in
            var value = try OpenAITextAnnotationAdded(wireJSON: json)
            value.additionalFields["annotation"] = .null
