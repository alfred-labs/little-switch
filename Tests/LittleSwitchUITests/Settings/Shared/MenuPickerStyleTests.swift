...
struct MenuPickerStyleTests {
    ...
    func sharedMenuPickerStyle() throws {
        let callSiteFiles = [
            "Settings/Shared/SettingsMappingRow.swift",
            "Settings/Clients/ClaudeCode/ClaudeCodeSettingsView.swift",
            "Settings/Providers/ProviderEditor.swift",
        ]
        ...
        for file in [
            "Settings/Clients/Claude/ClaudeSettingsView.swift", "Settings/Clients/Codex/CodexSettingsView.swift",
            "Settings/Clients/OpenCode/OpenCodeSettingsView.swift",
        ] {
        ...
        let layout = try source(named: "Settings/Shared/SettingsLayout.swift")
