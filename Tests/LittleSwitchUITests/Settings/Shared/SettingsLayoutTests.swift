...
struct SettingsLayoutTests {
    ...
    func flatIntegratedSidebar() throws {
        let settingsSource = try source(named: "Settings/Root/SettingsView.swift")
        let splitSource = try source(named: "Settings/Root/SettingsSplitView.swift")
    ...
    func flatCompactSidebar() throws {
        let viewsSource = try source(named: "Settings/Root/SettingsView.swift")
        let chromeSource = try source(named: "Settings/Root/SettingsChrome.swift")
    ...
    func airyClaudeRoutingRows() throws {
        let pageSource = try source(named: "Settings/Clients/Claude/ClaudeSettingsView.swift")
        let source = try source(named: "Settings/Shared/SettingsMappingRow.swift")
...
extension SettingsLayoutTests {
    ...
    func claudeCodeDefaultModelVariants() throws {
        let pageSource = try source(named: "Settings/Clients/ClaudeCode/ClaudeCodeSettingsView.swift")
    ...
    func claudeSingleApplyAction() throws {
        let pageSource = try source(named: "Settings/Clients/ClaudeCode/ClaudeCodeSettingsView.swift")
        let claudeSource = try source(named: "Settings/Clients/Claude/ClaudeSettingsView.swift")
