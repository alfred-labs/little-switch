...
struct ProviderEditorSaveFeedbackTests {
    ...
    func editorShowsTwoTestStages() throws {
        let source = try loadSource("Features/Providers/ProviderEditor.swift")
    ...
    func settingsViewClosesOnlyOnSuccess() throws {
        let source = try loadSource("Features/Providers/ProvidersSettingsView.swift")
    ...
    private func loadSource(_ file: String) throws -> String {
        ...
        let files =
            file == "Features/Providers/ProviderEditor.swift"
            ? [
                file, "Features/Providers/ProviderEditorCredentials.swift",
                "Features/Providers/ProviderEditorAdvanced.swift", "Features/Providers/ProviderEditorNotice.swift",
            ]
            : [file]
        return
            try files
