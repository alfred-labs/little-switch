...
public struct OpenAIChatRequestAssistant: Sendable, WireCodable {
    ...
    public init(wireJSON: JSONValue) throws {
        ...
        self.init(
            ...
            toolCalls: try object.optional(Key.toolCalls.rawValue),
    ...
    public func wireJSON() throws -> JSONValue {
        ...
        try object.setOptional(self.toolCalls, for: Key.toolCalls.rawValue)
