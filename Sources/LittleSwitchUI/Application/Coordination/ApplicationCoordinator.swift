...
public actor ApplicationCoordinator {
    ...
    let chatGPTLaunchTrust: ChatGPTLaunchTrust?
    let inheritedEnvironment: [String: String]
    var chatGPTLaunchEnvironment: [String: String]?
    var chatGPTListenerAuthorityPEM: String?
    ...
    public init(
        ...
        chatGPTLaunchTrust: ChatGPTLaunchTrust? = nil,
        ...
        self.chatGPTLaunchTrust = chatGPTLaunchTrust
